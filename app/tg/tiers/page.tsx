...
const tierCards: TierAccordionCard[] = [
  ...
  },
  {
    ...
    price: "80 EUR / месяц",
    teaser: "Самые эксклюзивные материалы и отдельная закрытая ветка контента.",
    description:
      "Тут будет всё самое редкое и личное: отдельные закрытые публикации, самые глубокие backstage-материалы, пилон-контент и то, что не попадает в остальные уровни. Это уровень для тех, кто хочет максимум доступа внутри клуба и отдельную ветку без лишнего шума.",
    symbol: "moon",
    ...
    sections: [
      {
        ...
        items: [
          "Всё из VIP",
          "Самый высокий доступ внутри клуба",
          "Эксклюзивный контент на пилоне",
          "Материалы, которые не попадут в другие тарифы"
        ]
      }
    ]
  }
