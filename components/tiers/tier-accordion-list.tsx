...
export function TierAccordionList({ cards }: { cards: TierAccordionCard[] }) {
        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="relative z-10 w-full px-3.5 py-3.5 text-left sm:px-5 sm:py-5"
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <div
                  className={`mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-white/10 bg-black/20 text-lg text-white/82 transition duration-300 ${
